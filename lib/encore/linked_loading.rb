require 'encore/linked_loading/belongs_to'
require 'encore/linked_loading/has_many'
require 'encore/linked_loading/has_one'

module Encore
  module LinkedLoading
    extend ActiveSupport::Concern
    include Encore::LinkedLoading::HasMany
    include Encore::LinkedLoading::HasOne
    include Encore::LinkedLoading::BelongsTo
